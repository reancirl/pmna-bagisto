        ...
        <a href="{{ route('admin.dashboard.index') }}">
            ...
            @else
                <img
                    ...
                    src="{{ request()->cookie('dark_mode') ? asset('images/pmna_white.png') : asset('images/pmna_black.svg') }}"
                    class="h-16"
                    id="logo-image"
                    alt="{{ config('app.name') }}"
                />
        ...
        app.component('v-dark', {
            ...
            data() {
                return {
                    ...
                    logo: "{{ asset('images/pmna_black.svg') }}",

                    // dark_logo: "{{ bagisto_asset('images/dark-logo.svg') }}",
                    dark_logo: "{{ asset('images/pmna_white.png') }}"
                };
            },
